...
$EndDescr
$Comp
L Main-rescue:LM5165Y-Regulator_Switching U37
U 1 1 5D0E5A03
P 5550 3900
F 0 "U37" H 5550 4467 50  0000 C CNN
...
$EndComp
$Comp
L Main-rescue:GNDD-power #PWR0331
U 1 1 5D0E5A09
P 5450 4400
F 0 "#PWR0331" H 5450 4150 50  0001 C CNN
...
$EndComp
$Comp
L Main-rescue:GNDD-power #PWR0332
U 1 1 5D0E5A0F
P 6500 3900
F 0 "#PWR0332" H 6500 3650 50  0001 C CNN
...
$Comp
L Main-rescue:C-Device C167
U 1 1 5D0E5A17
P 6500 3750
F 0 "C167" H 6615 3796 50  0000 L CNN
...
Wire Wire Line
	6250 3600 6500 3600
$Comp
L Main-rescue:GNDD-power #PWR0333
U 1 1 5D0E5A20
P 4650 3900
F 0 "#PWR0333" H 4650 3650 50  0001 C CNN
...
Wire Wire Line
	4450 3600 4650 3600
$Comp
L Main-rescue:C-Device C166
U 1 1 5D0E5A28
P 4650 3750
F 0 "C166" H 4765 3796 50  0000 L CNN
...
Wire Wire Line
	6350 4100 6250 4100
$Comp
L Main-rescue:GNDD-power #PWR0334
U 1 1 5D0E5A2F
P 6350 4100
F 0 "#PWR0334" H 6350 3850 50  0001 C CNN
...
$EndComp
$Comp
L Main-rescue:R-Device R181
U 1 1 5D0E5A35
P 6100 4100
F 0 "R181" V 6200 4100 50  0000 C CNN
...
Wire Wire Line
	5950 3800 6250 3800
$Comp
L Main-rescue:L-Device L27
U 1 1 5D0E5A42
P 6100 3600
F 0 "L27" V 6290 3600 50  0000 C CNN
...
Wire Wire Line
	4950 4000 5150 4000
$Comp
L Main-rescue:GNDD-power #PWR0335
U 1 1 5D0E5A49
P 4950 4000
F 0 "#PWR0335" H 4950 3750 50  0001 C CNN
...
$EndComp
$Comp
L Main-rescue:GNDD-power #PWR0336
U 1 1 5D0E5A54
P 5150 4200
F 0 "#PWR0336" H 5150 3950 50  0001 C CNN
